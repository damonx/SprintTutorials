...
public class BookServiceFactory {
	...
	public static BookServiceBean getProxyInstance(final MyCglibProxy myProxy) {
	...
	public static BookServiceBean getAuthInstanceByFilter(final MyCglibProxy myProxy) {
		final Enhancer en = new Enhancer();
		en.setSuperclass(BookServiceBean.class);
